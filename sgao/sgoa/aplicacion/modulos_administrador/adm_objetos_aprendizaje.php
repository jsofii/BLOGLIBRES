            ...
            <div class="row content">
                <div class="col-sm-6 col-sm-offset-3"> 
                    ...
                    <form onsubmit="return validar_formulario()" action="../modulos_administrador/adm_ejecutar_insertar_oa.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="file">Imagen del objeto de aprendizaje:</label>
                            <p id="error1" style="display:none; color:#FF0000;">
                                Formato de archivo ínvalido! Solo se admiten imagenes.
                            </p>
                            <p id="error2" style="display:none; color:#FF0000;">
                                El límite máximo de tamaño de archivo es 10MB.
                            </p>
                            <input type="file" class="form-control" id="o_aprendizaje2" name="archivo2" required>
                        </div>
